...
# Impl: simple
# Client: Main
# An implementation of ExtractMeetingRequestInfo.
...
__partial_deserializer = Deserializer[PartialMeetingRequest](PartialMeetingRequest)  # type: ignore
...
def simple_stream(*, convo: Conversation, now: str
...
BAMLExtractMeetingRequestInfo.register_impl("simple")(simple, simple_stream)